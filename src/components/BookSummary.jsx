...
const exampleBookDelete = {
  ...
  covers: [
    14625765, 11658206, 13120659, 12524639, 12524640, 13217523, 13601172,
    13344549, 10515650,
  ],
  subject_places: [
    "Mordor",
  ...
  last_modified: {
    type: "/type/datetime",
    value: "2025-02-12T22:13:21.531592",
  },
};

const MAX_WORDS_IN_SUMMARY = 40;

function BookSummary({ bookKey }) {
  // bookKey comes from the search API the form of "/works/OL5738148W".
  // It is appended to the API_BASE_URL to fetch the book details.
  // TODO fetch data

  // TODO change exampleBookDelete to book
  const description = exampleBookDelete.description?.value || "";
